...
- [v4.0 Overview](./v4.md) - CSS theme variables feature
- [Custom Styles](./custom-styles.md) - Best practices for customization
- [Functions and Directives](./functions-and-directives.md) - `@theme` directive reference
- [Colors](./colors.md) - Color theme variables
- [Responsive Design](./responsive-design.md) - Breakpoint theme variables
...
./node*modules/tailwindcss/theme.css
@theme {
