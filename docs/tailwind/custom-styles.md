...
- [Theme Variables](./theme-varibles.md) - Defining design tokens
- [Functions and Directives](./functions-and-directives.md) - `@utility`, `@variant` directives
- [Colors](./colors.md) - Custom color definitions
- [Dark Mode](./dark-mode.md) - Custom dark mode variants
- [Preflight](./preflight.md) - Base styles to override
...
opacity: calc(--value(integer) _ 1%);
...
@utility tab-_ {
tab-size: --value(--tab-size-_, integer, [integer]);
}
@utility opacity-_ {
opacity: calc(--value(integer) _ 1%);
...
@utility -inset-_ {
inset: --spacing(--value(integer) _ -1);
inset: calc(--value([percentage], [length]) _ -1);
}
Modifiers
...
CSS
@utility text-_ {
font-size: --value(--text-_, [length]);
line-height: --modifier(--leading-_, [length], [_]);
}
...
CSS
@utility aspect-_ {
aspect-ratio: --value(--aspect-ratio-_, ratio, [ratio]);
}
