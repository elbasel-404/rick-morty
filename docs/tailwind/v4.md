...
- [Theme Variables](./theme-varibles.md) - CSS-first configuration with `@theme`
- [Functions and Directives](./functions-and-directives.md) - New directives in v4
- [Custom Styles](./custom-styles.md) - Extending the framework
- [Colors](./colors.md) - Modernized P3 color palette
...
export default {
  plugins: [
    "postcss-import", // ❌ No longer needed
    "@tailwindcss/postcss",
  ],
};
```
