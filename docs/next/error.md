...
- **[Server and Client Components](./server-client.md)** - Error boundaries must be Client Components

### Advanced Routing

- **[Parallel Routes](./parallel-routes.md)** - Independent error boundaries for each parallel route

### Data & Caching

- **[Fetching Data](./fetching-data.md)** - Handle data fetching errors
- **[Caching Overview](./cache.md)** - Error handling with cached data
