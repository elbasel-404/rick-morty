...
- **[Fetching Data](./fetching-data.md)** - How to fetch data in Server and Client Components
...
- **[Cache Components](./cache-components.md)** - Mix static and dynamic rendering with `"use cache"`
- **[Parallel Routes](./parallel-routes.md)** - Render multiple pages simultaneously
- **[Lazy Loading](./lazy.md)** - Code splitting for Client Components
