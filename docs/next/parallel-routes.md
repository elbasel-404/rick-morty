...
- **[Slots](./slots.md)** - Named slots for parallel routes (`@folder` convention)
- **[Intercepting Routes](./intercepting-routes.md)** - Intercept navigation for modals/overlays

### UI Patterns

- **[Loading States](./loading.md)** - Independent loading UI for each parallel route
- **[Error Handling](./error.md)** - Independent error boundaries for each parallel route

### Core Concepts

- **[Server and Client Components](./server-client.md)** - Understanding rendering environments
- **[Caching Overview](./cache.md)** - How caching works with parallel routes
