...
- **[use cache](./use-cache.md)** - Function-level caching directive
- **[Cache & Revalidate](./cache-and-revalidate.md)** - Overview of cache revalidation strategies

### Cache Invalidation

- **[Cache Tags](./cache-tag.md)** - Tag cached components for granular invalidation
- **[revalidateTag](./revalidate-tag.md)** - Revalidate cached components by tag
- **[Update Tag](./update-tag.md)** - Immediate cache tag updates

### Core Concepts

- **[Server and Client Components](./server-client.md)** - Mix static and dynamic rendering
- **[Fetching Data](./fetching-data.md)** - How to fetch data in components
- **[Loading States](./loading.md)** - Show loading UI for cached components
