...
- **[revalidatePath](./revalidate-path.md)** - Revalidate data by path (broader scope)
- **[Cache Tags](./cache-tag.md)** - Tag cached data for targeted invalidation
- **[Update Tag](./update-tag.md)** - Immediate cache tag updates (recommended for Server Actions)
...
- **[Cache Components](./cache-components.md)** - React Server Components with `"use cache"`

### Data Management

- **[Update Data](./update-data.md)** - Patterns for updating data with Server Actions
- **[Fetching Data](./fetching-data.md)** - How to fetch and cache data
