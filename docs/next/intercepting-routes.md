...
> **Good to know:** The `(..)` convention is based on _route segments_, not the file-system. For example, it does not consider `@slot` folders in [Parallel Routes](/docs/app/api-reference/file-conventions/parallel-routes.md).
...
- **[Parallel Routes](./parallel-routes.md)** ⭐ - Essential companion for modal patterns
- **[Slots](./slots.md)** - Named slots used with parallel routes

### UI Patterns

- **[Loading States](./loading.md)** - Loading UI for intercepted routes
- **[Error Handling](./error.md)** - Error boundaries for intercepted routes

### Core Concepts

- **[Server and Client Components](./server-client.md)** - Client Components for interactive modals

### See Also

- **[README](./README.md)** - Complete Next.js documentation index
