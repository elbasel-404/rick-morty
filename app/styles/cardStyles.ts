...
export const textShadowVariants = cva("", {
	variants: {
		intensity: {
			...
			subtle: "[text-shadow:0_2px_6px_rgba(0,0,0,0.9),0_0_12px_rgba(0,0,0,0.4)]",
...
export const gradientVariants = cva("", {
	variants: {
		type: {
			...
			scanLine: "bg-[repeating-linear-gradient(0deg,transparent,transparent_2px,rgba(139,92,246,0.1)_2px,rgba(139,92,246,0.1)_4px)]",
		},
	},
});
