interface CyberLocationsProps {
  origin: string;
  location: string;
}

export const CyberLocations = ({ origin, location }: CyberLocationsProps) => {
  return (
    <div
    ...
    >
      <div
        className="relative border-l-3 sm:border-l-4 md:border-l-5 border-cyan-500 p-3 sm:p-4 md:p-5 clip-corner-small overflow-hidden transition-all"
        style={{
          boxShadow:
            "0 0 20px rgba(6, 182, 212, 0.3), inset 0 0 15px rgba(6, 182, 212, 0.05)",
        }}
      >
      ...
      <div
        className="relative border-l-3 sm:border-l-4 md:border-l-5 border-pink-500 p-3 sm:p-4 md:p-5 clip-corner-small overflow-hidden transition-all"
        style={{
          boxShadow:
            "0 0 20px rgba(236, 72, 153, 0.3), inset 0 0 15px rgba(236, 72, 153, 0.05)",
        }}
      >
